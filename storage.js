const increments = () =>{
    ...
    document.getElementById("tottla1").innerText = (curentQuantity + 1) * totalPrice;
}
const decrements = () =>{
    var curentQuantity = parseInt(document.getElementById("itemquantity").innerText);
    var currentPrice = parseInt(document.getElementById("price1").innerText);
    ...
    if(curentQuantity >= 1){
        if(curentQuantity == 0){
            ...
            document.getElementById("tottla1").innerText = (newcurentQuantity - 1) * totalPrice;
        }
    }
}
// second item
const increments1 = () =>{
    ...
    document.getElementById("tottla2").innerText = (curentQuantity + 1) * totalPrice;
}
const decrements1 = () =>{
    var curentQuantity = parseInt(document.getElementById("itemquantity2").innerText);
    var currentPrice = parseInt(document.getElementById("price2").innerText);
    ...
    if(curentQuantity >= 1){
        if(curentQuantity == 0){
            ...
            document.getElementById("tottla2").innerText = (newcurentQuantity - 1) * totalPrice;
        }
    }
}
// thirditem
const increments2 = () =>{
    ...
    document.getElementById("tottla3").innerText = (curentQuantity + 1) * totalPrice;
}
const decrements2 = () =>{
    var curentQuantity = parseInt(document.getElementById("itemquantity3").innerText);
    var currentPrice = parseInt(document.getElementById("price3").innerText);
    ...
    if(curentQuantity >= 1){
        if(curentQuantity == 0){
            ...
            document.getElementById("tottla3").innerText = (newcurentQuantity - 1) * totalPrice;
        }
    }
}
// fouth
const increments3 = () =>{
    ...
    document.getElementById("tottla4").innerText = (curentQuantity + 1) * totalPrice;
}
const decrements3 = () =>{
    var curentQuantity = parseInt(document.getElementById("itemquantity4").innerText);
    var currentPrice = parseInt(document.getElementById("price4").innerText);
    ...
    if(curentQuantity >= 1){
        if(curentQuantity == 0){
            ...
            document.getElementById("tottla4").innerText = (newcurentQuantity - 1) * totalPrice;
        }
    }
}
// fifth
const increments4 = () =>{
    ...
    document.getElementById("tottla5").innerText = (curentQuantity + 1) * totalPrice;
}
const decrements4 = () =>{
    var curentQuantity = parseInt(document.getElementById("itemquantity5").innerText);
    var currentPrice = parseInt(document.getElementById("price5").innerText);
    ...
    if(curentQuantity >= 1){
        if(curentQuantity == 0){
            ...
            document.getElementById("tottla5").innerText = (newcurentQuantity - 1) * totalPrice;
        }
    }
}
// sixth
const increments5 = () =>{
    ...
    document.getElementById("tottla6").innerText = (curentQuantity + 1) * totalPrice;
}
const decrements5 = () =>{
    var curentQuantity = parseInt(document.getElementById("itemquantity6").innerText);
    var currentPrice = parseInt(document.getElementById("price6").innerText);
    ...
    if(curentQuantity >= 1){
        if(curentQuantity == 0){
            ...
            document.getElementById("tottla6").innerText = (newcurentQuantity - 1) * totalPrice;
        }
    }
}
// seventh
const increments6 = () =>{
    ...
    document.getElementById("tottla7").innerText = (curentQuantity + 1) * totalPrice;
}
const decrements6 = () =>{
    var curentQuantity = parseInt(document.getElementById("itemquantity7").innerText);
    var currentPrice = parseInt(document.getElementById("price7").innerText);
    ...
    if(curentQuantity >= 1){
        if(curentQuantity == 0){
            ...
            document.getElementById("tottla7").innerText = (newcurentQuantity - 1) * totalPrice;
        }
    }
}
// eighth
const increments7 = () =>{
    ...
    document.getElementById("tottla8").innerText = (curentQuantity + 1) * totalPrice;
}
const decrements7 = () =>{
    var curentQuantity = parseInt(document.getElementById("itemquantity8").innerText);
    var currentPrice = parseInt(document.getElementById("price8").innerText);
    ...
    if(curentQuantity >= 1){
        if(curentQuantity == 0){
            ...
            document.getElementById("tottla8").innerText = (newcurentQuantity - 1) * totalPrice;
        }
    }
}